            ...
            <div className="p-5 flex flex-col gap-4 " style={{
                ...
                <div className="mb-2 flex justify-between">
                    <div className="flex gap-2 items-center">
                        {/* Dashboard Link  */}
                        <Link to={'/dashboard'}>
                            <BsFillArrowLeftCircleFill size={27} />
                        </Link>
                ...
                <div className="mb-3">
                    ...
                    <input
                        ...
                        className=" placeholder-gray w-auto rounded-md p-1  text-md h-10 py-1 px-6"
                        style={{
                            background: mode === 'dark'
                                ? '#dcdde1'
                                : 'white',
                ...
                <div className="mb-3">
                    <input
                       ...
                       className={` w-full rounded-md p-1.5  text-md h-12 px-6
                ...
                {/* Four Editor  */}
                <Editor
                    apiKey='jnx4s8sfjappxvngf1m1t5srw32qi46pdfhxssir6la9vs8k'
                ...
                {/* Five Submit Button  */}
                <Button className=" w-full mt-5 text-lg"
                onClick={addPost}
                    style={{
                        background: mode === 'dark'
                            ? 'rgb(226, 232, 240)'
