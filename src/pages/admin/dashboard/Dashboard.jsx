        ...
        <Layout>
            <div className="py-10">
                <div
                    ...
                    <div className="left">
                        <img
                            className=" w-40 h-40  object-cover rounded-full border-2 border-green-600 p-1"
                    ...
                    <div className="right">
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">arshsandhuprofessional@gmail.com
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
                            <span></span>  
                ...
                <div className="">
                    <div className=' container mx-auto px-4 max-w-7xl my-5' >
                        <div className="relative overflow-x-auto shadow-md sm:rounded-xl">
                            {/* table  */}
                            <table className="w-full border-2 border-white shadow-md text-lg text-left text-gray-500 dark:text-gray-400" >
                                {/* thead  */}
                                <thead
                                    style={{
                                        background: mode === 'dark'
                                                ...
                                                <tr className=" border-b-2" style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : 'white' }}>
                                                    ...
                                                    onClick={()=> deleteBlogs(id)}
                                                     style={{ color: mode === 'dark' ? 'white' : 'black' }} className="px-6 py-4">
                                                        <button className=' px-4 py-0.5 rounded-sm text-white font-bold bg-red-500'>
                                                            Delete
                                                        </button>
                                                    </td>
                                                </tr>
